...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marcgenevat/ros_tutorials/catkin_ws/install/${idir}'.  Ask the maintainer 'marcgenevat <marcgenevat@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/marcgenevat/ros_tutorials/catkin_ws/install/lib;/opt/ros/indigo/lib)
